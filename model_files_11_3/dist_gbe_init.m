...
reuse_block(blk, 'packet_counter', 'xbsIndex_r4/Counter', 'n_bits','32', 'arith_type', 'Unsigned', ...
    'cnt_type', 'Free Running', 'rst', 'On', 'en', 'On', 'Position', [1865         119        1910         146]);
reuse_block(blk,['reg_packet_count'],'xps_library/software register',...
	'io_dir','To Processor',...
	'Position',[2000         115        2175         145]);

add_line(blk,['const_0/1'],['rst_packet_count/1']);
add_line(blk,['rst_packet_count/1'],['rst_slice/1']);
add_line(blk,['rst_slice/1'],['packet_counter/1']);
add_line(blk,['next_packet/1'],['packet_counter/2']);
add_line(blk,['packet_counter/1'],['reg_packet_count/1']);
